...
namespace CLabs.Tickets.Linq
{
    ...
    {
        public static ITicketAsyncEnumerable<TSource> TakeUntilCanceled<TSource>(this ITicketAsyncEnumerable<TSource> source, CancellationToken cancellationToken)
        {
    ...
    internal sealed class TakeUntilCanceled<TSource> : ITicketAsyncEnumerable<TSource>
    {
        readonly ITicketAsyncEnumerable<TSource> source;
        readonly CancellationToken cancellationToken;

        public TakeUntilCanceled(ITicketAsyncEnumerable<TSource> source, CancellationToken cancellationToken)
        {
            this.source = source;
        ...
        sealed class _TakeUntilCanceled : MoveNextSource, ITicketAsyncEnumerator<TSource>
        {
            ...
            public _TakeUntilCanceled(ITicketAsyncEnumerable<TSource> source, CancellationToken cancellationToken1, CancellationToken cancellationToken2)
            {
                this.source = source;
