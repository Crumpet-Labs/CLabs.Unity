...
namespace CLabs.Tickets.Linq
{
    ...
    {
        public static ITicketAsyncEnumerable<TSource> Skip<TSource>(this ITicketAsyncEnumerable<TSource> source, Int32 count)
        {
    ...
    internal sealed class Skip<TSource> : ITicketAsyncEnumerable<TSource>
    {
        readonly ITicketAsyncEnumerable<TSource> source;
        readonly int count;

        public Skip(ITicketAsyncEnumerable<TSource> source, int count)
        {
            this.source = source;
            this.count = count;
        }
        ...
        sealed class _Skip : AsyncEnumeratorBase<TSource, TSource>
        {
            ...
            public _Skip(ITicketAsyncEnumerable<TSource> source, int count, CancellationToken cancellationToken)
