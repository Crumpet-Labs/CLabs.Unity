...
namespace CLabs.Tickets.Linq
{
    ...
    {
        public static ITicketAsyncEnumerable<AsyncUnit> Timer(TimeSpan dueTime, PlayerLoopTiming updateTiming = PlayerLoopTiming.Update, bool ignoreTimeScale = false, bool cancelImmediately = false)
        {
            return new Timer(dueTime, null, updateTiming, ignoreTimeScale, cancelImmediately);
        }

        public static ITicketAsyncEnumerable<AsyncUnit> Timer(TimeSpan dueTime, TimeSpan period, PlayerLoopTiming updateTiming = PlayerLoopTiming.Update, bool ignoreTimeScale = false, bool cancelImmediately = false)
        {
            return new Timer(dueTime, period, updateTiming, ignoreTimeScale, cancelImmediately);
        }

        public static ITicketAsyncEnumerable<AsyncUnit> Interval(TimeSpan period, PlayerLoopTiming updateTiming = PlayerLoopTiming.Update, bool ignoreTimeScale = false, bool cancelImmediately = false)
        {
            return new Timer(period, period, updateTiming, ignoreTimeScale, cancelImmediately);
        }

        public static ITicketAsyncEnumerable<AsyncUnit> TimerFrame(int dueTimeFrameCount, PlayerLoopTiming updateTiming = PlayerLoopTiming.Update, bool cancelImmediately = false)
        {
        ...
        public static ITicketAsyncEnumerable<AsyncUnit> TimerFrame(int dueTimeFrameCount, int periodFrameCount, PlayerLoopTiming updateTiming = PlayerLoopTiming.Update, bool cancelImmediately = false)
        {
            if (dueTimeFrameCount < 0)
            {
                throw new ArgumentOutOfRangeException("Delay does not allow minus delayFrameCount. dueTimeFrameCount:" + dueTimeFrameCount);
        ...
        public static ITicketAsyncEnumerable<AsyncUnit> IntervalFrame(int intervalFrameCount, PlayerLoopTiming updateTiming = PlayerLoopTiming.Update, bool cancelImmediately = false)
        {
    ...
    internal sealed class Timer : ITicketAsyncEnumerable<AsyncUnit>
    {
        ...
        class _Timer : MoveNextSource, ITicketAsyncEnumerator<AsyncUnit>, IPlayerLoopItem
        {
            ...
            public _Timer(TimeSpan dueTime, TimeSpan? period, PlayerLoopTiming updateTiming, bool ignoreTimeScale, CancellationToken cancellationToken, bool cancelImmediately)
            {
                ...
                this.initialFrame = TicketRuntime.IsMainThread ? TicketRuntime.FrameCount : -1;
            ...
            public bool MoveNext()
            {
                ...
                if (dueTimePhase)
                {
                    ...
                    elapsed += (ignoreTimeScale) ? TicketRuntime.UnscaledDeltaTime : TicketRuntime.DeltaTime;
    ...
    internal sealed class TimerFrame : ITicketAsyncEnumerable<AsyncUnit>
    {
        readonly PlayerLoopTiming updateTiming;
        ...
        class _TimerFrame : MoveNextSource, ITicketAsyncEnumerator<AsyncUnit>, IPlayerLoopItem
        {
            readonly int dueTimeFrameCount;
            readonly int? periodFrameCount;
            readonly CancellationToken cancellationToken;
