...
namespace CLabs.Crumb {
    /// <summary>An <see cref="ICrumbSink"/> that fans each log line out to several sinks in order, for example the Unity console plus a <see cref="BufferedCrumbSink"/> for an editor view.</summary>
