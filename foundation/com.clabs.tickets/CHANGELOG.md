...
- remove unused Buttr.Core dependency from tickets + utility adapter (feb4d3c)
- correct docs to real bootstrapping, rebrand UniTask .tt/.cs, scrub private refs (7177615)
- drop in-development editor adapter from the public closure (c606fad)
...
- tickets named incorrectly (7cb1862)
