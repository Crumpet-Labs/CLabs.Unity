...
namespace CLabs.Tickets.Triggers
{
#region FixedUpdate
    ...
    {
        Ticket IAsyncFixedUpdateHandler.FixedUpdateAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncFixedUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket FixedUpdateAsync()
        {
            return ((IAsyncFixedUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).FixedUpdateAsync();
        }

        public Ticket FixedUpdateAsync(CancellationToken cancellationToken)
        {
...
#region LateUpdate
    ...
    {
        Ticket IAsyncLateUpdateHandler.LateUpdateAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncLateUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket LateUpdateAsync()
        {
            return ((IAsyncLateUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).LateUpdateAsync();
        }

        public Ticket LateUpdateAsync(CancellationToken cancellationToken)
        {
...
#region AnimatorIK
    ...
    {
        Ticket<int> IAsyncOnAnimatorIKHandler.OnAnimatorIKAsync()
        {
            core.Reset();
            return new Ticket<int>((ITicketSource<int>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncAnimatorIKTrigger : AsyncTriggerBase<int>
    {
        ...
        public Ticket<int> OnAnimatorIKAsync()
        {
            return ((IAsyncOnAnimatorIKHandler)new AsyncTriggerHandler<int>(this, true)).OnAnimatorIKAsync();
        }

        public Ticket<int> OnAnimatorIKAsync(CancellationToken cancellationToken)
        {
...
#region AnimatorMove
    ...
    {
        Ticket IAsyncOnAnimatorMoveHandler.OnAnimatorMoveAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncAnimatorMoveTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnAnimatorMoveAsync()
        {
            return ((IAsyncOnAnimatorMoveHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnAnimatorMoveAsync();
        }

        public Ticket OnAnimatorMoveAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationFocus
    ...
    {
        Ticket<bool> IAsyncOnApplicationFocusHandler.OnApplicationFocusAsync()
        {
            core.Reset();
            return new Ticket<bool>((ITicketSource<bool>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncApplicationFocusTrigger : AsyncTriggerBase<bool>
    {
        ...
        public Ticket<bool> OnApplicationFocusAsync()
        {
            return ((IAsyncOnApplicationFocusHandler)new AsyncTriggerHandler<bool>(this, true)).OnApplicationFocusAsync();
        }

        public Ticket<bool> OnApplicationFocusAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationPause
    ...
    {
        Ticket<bool> IAsyncOnApplicationPauseHandler.OnApplicationPauseAsync()
        {
            core.Reset();
            return new Ticket<bool>((ITicketSource<bool>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationPauseTrigger : AsyncTriggerBase<bool>
    {
        ...
        public Ticket<bool> OnApplicationPauseAsync()
        {
            return ((IAsyncOnApplicationPauseHandler)new AsyncTriggerHandler<bool>(this, true)).OnApplicationPauseAsync();
        }

        public Ticket<bool> OnApplicationPauseAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationQuit
    ...
    {
        Ticket IAsyncOnApplicationQuitHandler.OnApplicationQuitAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationQuitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnApplicationQuitAsync()
        {
            return ((IAsyncOnApplicationQuitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnApplicationQuitAsync();
        }

        public Ticket OnApplicationQuitAsync(CancellationToken cancellationToken)
        {
...
#region AudioFilterRead
    ...
    {
        Ticket<(float[] data, int channels)> OnAudioFilterReadAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAudioFilterReadHandler
    {
        Ticket<(float[] data, int channels)> IAsyncOnAudioFilterReadHandler.OnAudioFilterReadAsync()
        {
            core.Reset();
            return new Ticket<(float[] data, int channels)>((ITicketSource<(float[] data, int channels)>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncAudioFilterReadTrigger : AsyncTriggerBase<(float[] data, int channels)>
    {
        ...
        public Ticket<(float[] data, int channels)> OnAudioFilterReadAsync()
        {
            return ((IAsyncOnAudioFilterReadHandler)new AsyncTriggerHandler<(float[] data, int channels)>(this, true)).OnAudioFilterReadAsync();
        }

        public Ticket<(float[] data, int channels)> OnAudioFilterReadAsync(CancellationToken cancellationToken)
        {
...
#region BecameInvisible
    ...
    {
        Ticket IAsyncOnBecameInvisibleHandler.OnBecameInvisibleAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBecameInvisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnBecameInvisibleAsync()
        {
            return ((IAsyncOnBecameInvisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnBecameInvisibleAsync();
        }

        public Ticket OnBecameInvisibleAsync(CancellationToken cancellationToken)
        {
...
#region BecameVisible
    ...
    {
        Ticket IAsyncOnBecameVisibleHandler.OnBecameVisibleAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBecameVisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnBecameVisibleAsync()
        {
            return ((IAsyncOnBecameVisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnBecameVisibleAsync();
        }

        public Ticket OnBecameVisibleAsync(CancellationToken cancellationToken)
        {
...
#region BeforeTransformParentChanged
    ...
    {
        Ticket IAsyncOnBeforeTransformParentChangedHandler.OnBeforeTransformParentChangedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBeforeTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnBeforeTransformParentChangedAsync()
        {
        ...
        public Ticket OnBeforeTransformParentChangedAsync(CancellationToken cancellationToken)
        {
...
#region OnCanvasGroupChanged
    ...
    {
        Ticket IAsyncOnCanvasGroupChangedHandler.OnCanvasGroupChangedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncOnCanvasGroupChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnCanvasGroupChangedAsync()
        {
            return ((IAsyncOnCanvasGroupChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnCanvasGroupChangedAsync();
        }

        public Ticket OnCanvasGroupChangedAsync(CancellationToken cancellationToken)
        {
...
#region CollisionEnter
#if !UNITY_2019_1_OR_NEWER || Ticket_PHYSICS_SUPPORT
    ...
    {
        Ticket<Collision> IAsyncOnCollisionEnterHandler.OnCollisionEnterAsync()
        {
            core.Reset();
            return new Ticket<Collision>((ITicketSource<Collision>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnterTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public Ticket<Collision> OnCollisionEnterAsync()
        {
            return ((IAsyncOnCollisionEnterHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionEnterAsync();
        }

        public Ticket<Collision> OnCollisionEnterAsync(CancellationToken cancellationToken)
        {
...
#region CollisionEnter2D
#if !UNITY_2019_1_OR_NEWER || Ticket_PHYSICS2D_SUPPORT
    ...
    {
        Ticket<Collision2D> IAsyncOnCollisionEnter2DHandler.OnCollisionEnter2DAsync()
        {
            core.Reset();
            return new Ticket<Collision2D>((ITicketSource<Collision2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnter2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public Ticket<Collision2D> OnCollisionEnter2DAsync()
        {
            return ((IAsyncOnCollisionEnter2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionEnter2DAsync();
        }

        public Ticket<Collision2D> OnCollisionEnter2DAsync(CancellationToken cancellationToken)
        {
...
#region CollisionExit
    ...
    {
        Ticket<Collision> IAsyncOnCollisionExitHandler.OnCollisionExitAsync()
        {
            core.Reset();
            return new Ticket<Collision>((ITicketSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExitTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public Ticket<Collision> OnCollisionExitAsync()
        {
            return ((IAsyncOnCollisionExitHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionExitAsync();
        }

        public Ticket<Collision> OnCollisionExitAsync(CancellationToken cancellationToken)
        {
...
#region CollisionExit2D
    ...
    {
        Ticket<Collision2D> IAsyncOnCollisionExit2DHandler.OnCollisionExit2DAsync()
        {
            core.Reset();
            return new Ticket<Collision2D>((ITicketSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExit2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public Ticket<Collision2D> OnCollisionExit2DAsync()
        {
            return ((IAsyncOnCollisionExit2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionExit2DAsync();
        }

        public Ticket<Collision2D> OnCollisionExit2DAsync(CancellationToken cancellationToken)
        {
...
#region CollisionStay
    ...
    {
        Ticket<Collision> IAsyncOnCollisionStayHandler.OnCollisionStayAsync()
        {
            core.Reset();
            return new Ticket<Collision>((ITicketSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStayTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public Ticket<Collision> OnCollisionStayAsync()
        {
            return ((IAsyncOnCollisionStayHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionStayAsync();
        }

        public Ticket<Collision> OnCollisionStayAsync(CancellationToken cancellationToken)
        {
...
#region CollisionStay2D
    ...
    {
        Ticket<Collision2D> IAsyncOnCollisionStay2DHandler.OnCollisionStay2DAsync()
        {
            core.Reset();
            return new Ticket<Collision2D>((ITicketSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStay2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public Ticket<Collision2D> OnCollisionStay2DAsync()
        {
            return ((IAsyncOnCollisionStay2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionStay2DAsync();
        }

        public Ticket<Collision2D> OnCollisionStay2DAsync(CancellationToken cancellationToken)
        {
...
#region ControllerColliderHit
    ...
    {
        Ticket<ControllerColliderHit> IAsyncOnControllerColliderHitHandler.OnControllerColliderHitAsync()
        {
            core.Reset();
            return new Ticket<ControllerColliderHit>((ITicketSource<ControllerColliderHit>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncControllerColliderHitTrigger : AsyncTriggerBase<ControllerColliderHit>
    {
        ...
        public Ticket<ControllerColliderHit> OnControllerColliderHitAsync()
        {
        ...
        public Ticket<ControllerColliderHit> OnControllerColliderHitAsync(CancellationToken cancellationToken)
        {
...
#region Disable
    ...
    {
        Ticket IAsyncOnDisableHandler.OnDisableAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDisableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnDisableAsync()
        {
            return ((IAsyncOnDisableHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDisableAsync();
        }

        public Ticket OnDisableAsync(CancellationToken cancellationToken)
        {
...
#region DrawGizmos
    ...
    {
        Ticket IAsyncOnDrawGizmosHandler.OnDrawGizmosAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDrawGizmosTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnDrawGizmosAsync()
        {
            return ((IAsyncOnDrawGizmosHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDrawGizmosAsync();
        }

        public Ticket OnDrawGizmosAsync(CancellationToken cancellationToken)
        {
...
#region DrawGizmosSelected
    ...
    {
        Ticket IAsyncOnDrawGizmosSelectedHandler.OnDrawGizmosSelectedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDrawGizmosSelectedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnDrawGizmosSelectedAsync()
        {
            return ((IAsyncOnDrawGizmosSelectedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDrawGizmosSelectedAsync();
        }

        public Ticket OnDrawGizmosSelectedAsync(CancellationToken cancellationToken)
        {
...
#region Enable
    ...
    {
        Ticket IAsyncOnEnableHandler.OnEnableAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncEnableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnEnableAsync()
        {
            return ((IAsyncOnEnableHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnEnableAsync();
        }

        public Ticket OnEnableAsync(CancellationToken cancellationToken)
        {
...
#region GUI
    ...
    {
        Ticket IAsyncOnGUIHandler.OnGUIAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncGUITrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnGUIAsync()
        {
            return ((IAsyncOnGUIHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnGUIAsync();
        }

        public Ticket OnGUIAsync(CancellationToken cancellationToken)
        {
...
#region JointBreak
    ...
    {
        Ticket<float> IAsyncOnJointBreakHandler.OnJointBreakAsync()
        {
            core.Reset();
            return new Ticket<float>((ITicketSource<float>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreakTrigger : AsyncTriggerBase<float>
    {
        ...
        public Ticket<float> OnJointBreakAsync()
        {
            return ((IAsyncOnJointBreakHandler)new AsyncTriggerHandler<float>(this, true)).OnJointBreakAsync();
        }

        public Ticket<float> OnJointBreakAsync(CancellationToken cancellationToken)
        {
...
#region JointBreak2D
    ...
    {
        Ticket<Joint2D> IAsyncOnJointBreak2DHandler.OnJointBreak2DAsync()
        {
            core.Reset();
            return new Ticket<Joint2D>((ITicketSource<Joint2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreak2DTrigger : AsyncTriggerBase<Joint2D>
    {
        ...
        public Ticket<Joint2D> OnJointBreak2DAsync()
        {
            return ((IAsyncOnJointBreak2DHandler)new AsyncTriggerHandler<Joint2D>(this, true)).OnJointBreak2DAsync();
        }

        public Ticket<Joint2D> OnJointBreak2DAsync(CancellationToken cancellationToken)
        {
...
#region MouseDown
    ...
    {
        Ticket IAsyncOnMouseDownHandler.OnMouseDownAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDownTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnMouseDownAsync()
        {
            return ((IAsyncOnMouseDownHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseDownAsync();
        }

        public Ticket OnMouseDownAsync(CancellationToken cancellationToken)
        {
...
#region MouseDrag
    ...
    {
        Ticket IAsyncOnMouseDragHandler.OnMouseDragAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDragTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnMouseDragAsync()
        {
            return ((IAsyncOnMouseDragHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseDragAsync();
        }

        public Ticket OnMouseDragAsync(CancellationToken cancellationToken)
        {
...
#region MouseEnter
    ...
    {
        Ticket IAsyncOnMouseEnterHandler.OnMouseEnterAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseEnterTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnMouseEnterAsync()
        {
            return ((IAsyncOnMouseEnterHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseEnterAsync();
        }

        public Ticket OnMouseEnterAsync(CancellationToken cancellationToken)
        {
...
#region MouseExit
    ...
    {
        Ticket IAsyncOnMouseExitHandler.OnMouseExitAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseExitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnMouseExitAsync()
        {
            return ((IAsyncOnMouseExitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseExitAsync();
        }

        public Ticket OnMouseExitAsync(CancellationToken cancellationToken)
        {
...
#region MouseOver
    ...
    {
        Ticket IAsyncOnMouseOverHandler.OnMouseOverAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseOverTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnMouseOverAsync()
        {
            return ((IAsyncOnMouseOverHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseOverAsync();
        }

        public Ticket OnMouseOverAsync(CancellationToken cancellationToken)
        {
...
#region MouseUp
    ...
    {
        Ticket IAsyncOnMouseUpHandler.OnMouseUpAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnMouseUpAsync()
        {
            return ((IAsyncOnMouseUpHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseUpAsync();
        }

        public Ticket OnMouseUpAsync(CancellationToken cancellationToken)
        {
...
#region MouseUpAsButton
    ...
    {
        Ticket IAsyncOnMouseUpAsButtonHandler.OnMouseUpAsButtonAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpAsButtonTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnMouseUpAsButtonAsync()
        {
            return ((IAsyncOnMouseUpAsButtonHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseUpAsButtonAsync();
        }

        public Ticket OnMouseUpAsButtonAsync(CancellationToken cancellationToken)
        {
...
#region ParticleCollision
    ...
    {
        Ticket<GameObject> IAsyncOnParticleCollisionHandler.OnParticleCollisionAsync()
        {
            core.Reset();
            return new Ticket<GameObject>((ITicketSource<GameObject>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncParticleCollisionTrigger : AsyncTriggerBase<GameObject>
    {
        ...
        public Ticket<GameObject> OnParticleCollisionAsync()
        {
            return ((IAsyncOnParticleCollisionHandler)new AsyncTriggerHandler<GameObject>(this, true)).OnParticleCollisionAsync();
        }

        public Ticket<GameObject> OnParticleCollisionAsync(CancellationToken cancellationToken)
        {
...
#region ParticleSystemStopped
    ...
    {
        Ticket IAsyncOnParticleSystemStoppedHandler.OnParticleSystemStoppedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncParticleSystemStoppedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnParticleSystemStoppedAsync()
        {
            return ((IAsyncOnParticleSystemStoppedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnParticleSystemStoppedAsync();
        }

        public Ticket OnParticleSystemStoppedAsync(CancellationToken cancellationToken)
        {
...
#region ParticleTrigger
    ...
    {
        Ticket IAsyncOnParticleTriggerHandler.OnParticleTriggerAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncParticleTriggerTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnParticleTriggerAsync()
        {
            return ((IAsyncOnParticleTriggerHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnParticleTriggerAsync();
        }

        public Ticket OnParticleTriggerAsync(CancellationToken cancellationToken)
        {
...
#region ParticleUpdateJobScheduled
#if UNITY_2019_3_OR_NEWER && (!UNITY_2019_1_OR_NEWER || Ticket_PARTICLESYSTEM_SUPPORT)
    ...
    {
        Ticket<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> IAsyncOnParticleUpdateJobScheduledHandler.OnParticleUpdateJobScheduledAsync()
        {
            core.Reset();
            return new Ticket<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>((ITicketSource<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncParticleUpdateJobScheduledTrigger : AsyncTriggerBase<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>
    {
        ...
        public Ticket<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync()
        {
        ...
        public Ticket<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync(CancellationToken cancellationToken)
        {
...
#region PostRender
    ...
    {
        Ticket IAsyncOnPostRenderHandler.OnPostRenderAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPostRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnPostRenderAsync()
        {
            return ((IAsyncOnPostRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPostRenderAsync();
        }

        public Ticket OnPostRenderAsync(CancellationToken cancellationToken)
        {
...
#region PreCull
    ...
    {
        Ticket IAsyncOnPreCullHandler.OnPreCullAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPreCullTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnPreCullAsync()
        {
            return ((IAsyncOnPreCullHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPreCullAsync();
        }

        public Ticket OnPreCullAsync(CancellationToken cancellationToken)
        {
...
#region PreRender
    ...
    {
        Ticket IAsyncOnPreRenderHandler.OnPreRenderAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPreRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnPreRenderAsync()
        {
            return ((IAsyncOnPreRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPreRenderAsync();
        }

        public Ticket OnPreRenderAsync(CancellationToken cancellationToken)
        {
...
#region RectTransformDimensionsChange
    ...
    {
        Ticket IAsyncOnRectTransformDimensionsChangeHandler.OnRectTransformDimensionsChangeAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRectTransformDimensionsChangeTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnRectTransformDimensionsChangeAsync()
        {
        ...
        public Ticket OnRectTransformDimensionsChangeAsync(CancellationToken cancellationToken)
        {
...
#region RectTransformRemoved
    ...
    {
        Ticket IAsyncOnRectTransformRemovedHandler.OnRectTransformRemovedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRectTransformRemovedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnRectTransformRemovedAsync()
        {
            return ((IAsyncOnRectTransformRemovedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnRectTransformRemovedAsync();
        }

        public Ticket OnRectTransformRemovedAsync(CancellationToken cancellationToken)
        {
...
#region RenderImage
    ...
    {
        Ticket<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRenderImageHandler
    {
        Ticket<(RenderTexture source, RenderTexture destination)> IAsyncOnRenderImageHandler.OnRenderImageAsync()
        {
            core.Reset();
            return new Ticket<(RenderTexture source, RenderTexture destination)>((ITicketSource<(RenderTexture source, RenderTexture destination)>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncRenderImageTrigger : AsyncTriggerBase<(RenderTexture source, RenderTexture destination)>
    {
        ...
        public Ticket<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync()
        {
        ...
        public Ticket<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync(CancellationToken cancellationToken)
        {
...
#region RenderObject
    ...
    {
        Ticket IAsyncOnRenderObjectHandler.OnRenderObjectAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnRenderObjectAsync()
        {
            return ((IAsyncOnRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnRenderObjectAsync();
        }

        public Ticket OnRenderObjectAsync(CancellationToken cancellationToken)
        {
...
#region ServerInitialized
    ...
    {
        Ticket IAsyncOnServerInitializedHandler.OnServerInitializedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncServerInitializedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnServerInitializedAsync()
        {
            return ((IAsyncOnServerInitializedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnServerInitializedAsync();
        }

        public Ticket OnServerInitializedAsync(CancellationToken cancellationToken)
        {
...
#region TransformChildrenChanged
    ...
    {
        Ticket IAsyncOnTransformChildrenChangedHandler.OnTransformChildrenChangedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTransformChildrenChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnTransformChildrenChangedAsync()
        {
        ...
        public Ticket OnTransformChildrenChangedAsync(CancellationToken cancellationToken)
        {
...
#region TransformParentChanged
    ...
    {
        Ticket IAsyncOnTransformParentChangedHandler.OnTransformParentChangedAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnTransformParentChangedAsync()
        {
            return ((IAsyncOnTransformParentChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnTransformParentChangedAsync();
        }

        public Ticket OnTransformParentChangedAsync(CancellationToken cancellationToken)
        {
...
#region TriggerEnter
    ...
    {
        Ticket<Collider> IAsyncOnTriggerEnterHandler.OnTriggerEnterAsync()
        {
            core.Reset();
            return new Ticket<Collider>((ITicketSource<Collider>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnterTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public Ticket<Collider> OnTriggerEnterAsync()
        {
            return ((IAsyncOnTriggerEnterHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerEnterAsync();
        }

        public Ticket<Collider> OnTriggerEnterAsync(CancellationToken cancellationToken)
        {
...
#region TriggerEnter2D
    ...
    {
        Ticket<Collider2D> IAsyncOnTriggerEnter2DHandler.OnTriggerEnter2DAsync()
        {
            core.Reset();
            return new Ticket<Collider2D>((ITicketSource<Collider2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnter2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public Ticket<Collider2D> OnTriggerEnter2DAsync()
        {
            return ((IAsyncOnTriggerEnter2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerEnter2DAsync();
        }

        public Ticket<Collider2D> OnTriggerEnter2DAsync(CancellationToken cancellationToken)
        {
...
#region TriggerExit
    ...
    {
        Ticket<Collider> IAsyncOnTriggerExitHandler.OnTriggerExitAsync()
        {
            core.Reset();
            return new Ticket<Collider>((ITicketSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExitTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public Ticket<Collider> OnTriggerExitAsync()
        {
            return ((IAsyncOnTriggerExitHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerExitAsync();
        }

        public Ticket<Collider> OnTriggerExitAsync(CancellationToken cancellationToken)
        {
...
#region TriggerExit2D
    ...
    {
        Ticket<Collider2D> IAsyncOnTriggerExit2DHandler.OnTriggerExit2DAsync()
        {
            core.Reset();
            return new Ticket<Collider2D>((ITicketSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExit2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public Ticket<Collider2D> OnTriggerExit2DAsync()
        {
            return ((IAsyncOnTriggerExit2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerExit2DAsync();
        }

        public Ticket<Collider2D> OnTriggerExit2DAsync(CancellationToken cancellationToken)
        {
...
#region TriggerStay
    ...
    {
        Ticket<Collider> IAsyncOnTriggerStayHandler.OnTriggerStayAsync()
        {
            core.Reset();
            return new Ticket<Collider>((ITicketSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStayTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public Ticket<Collider> OnTriggerStayAsync()
        {
            return ((IAsyncOnTriggerStayHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerStayAsync();
        }

        public Ticket<Collider> OnTriggerStayAsync(CancellationToken cancellationToken)
        {
...
#region TriggerStay2D
    ...
    {
        Ticket<Collider2D> IAsyncOnTriggerStay2DHandler.OnTriggerStay2DAsync()
        {
            core.Reset();
            return new Ticket<Collider2D>((ITicketSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStay2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public Ticket<Collider2D> OnTriggerStay2DAsync()
        {
            return ((IAsyncOnTriggerStay2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerStay2DAsync();
        }

        public Ticket<Collider2D> OnTriggerStay2DAsync(CancellationToken cancellationToken)
        {
...
#region Validate
    ...
    {
        Ticket IAsyncOnValidateHandler.OnValidateAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncValidateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnValidateAsync()
        {
            return ((IAsyncOnValidateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnValidateAsync();
        }

        public Ticket OnValidateAsync(CancellationToken cancellationToken)
        {
...
#region WillRenderObject
    ...
    {
        Ticket IAsyncOnWillRenderObjectHandler.OnWillRenderObjectAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncWillRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket OnWillRenderObjectAsync()
        {
            return ((IAsyncOnWillRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnWillRenderObjectAsync();
        }

        public Ticket OnWillRenderObjectAsync(CancellationToken cancellationToken)
        {
...
#region Reset
    ...
    {
        Ticket IAsyncResetHandler.ResetAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncResetTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket ResetAsync()
        {
            return ((IAsyncResetHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).ResetAsync();
        }

        public Ticket ResetAsync(CancellationToken cancellationToken)
        {
...
#region Update
    ...
    {
        Ticket IAsyncUpdateHandler.UpdateAsync()
        {
            core.Reset();
            return new Ticket((ITicketSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Ticket UpdateAsync()
        {
            return ((IAsyncUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).UpdateAsync();
        }

        public Ticket UpdateAsync(CancellationToken cancellationToken)
        {
...
#region BeginDrag
    ...
    {
        Ticket<PointerEventData> IAsyncOnBeginDragHandler.OnBeginDragAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncBeginDragTrigger : AsyncTriggerBase<PointerEventData>, IBeginDragHandler
    {
        ...
        public Ticket<PointerEventData> OnBeginDragAsync()
        {
            return ((IAsyncOnBeginDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnBeginDragAsync();
        }

        public Ticket<PointerEventData> OnBeginDragAsync(CancellationToken cancellationToken)
        {
...
#region Cancel
    ...
    {
        Ticket<BaseEventData> IAsyncOnCancelHandler.OnCancelAsync()
        {
            core.Reset();
            return new Ticket<BaseEventData>((ITicketSource<BaseEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCancelTrigger : AsyncTriggerBase<BaseEventData>, ICancelHandler
    {
        ...
        public Ticket<BaseEventData> OnCancelAsync()
        {
            return ((IAsyncOnCancelHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnCancelAsync();
        }

        public Ticket<BaseEventData> OnCancelAsync(CancellationToken cancellationToken)
        {
...
#region Deselect
    ...
    {
        Ticket<BaseEventData> IAsyncOnDeselectHandler.OnDeselectAsync()
        {
            core.Reset();
            return new Ticket<BaseEventData>((ITicketSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDeselectTrigger : AsyncTriggerBase<BaseEventData>, IDeselectHandler
    {
        ...
        public Ticket<BaseEventData> OnDeselectAsync()
        {
            return ((IAsyncOnDeselectHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnDeselectAsync();
        }

        public Ticket<BaseEventData> OnDeselectAsync(CancellationToken cancellationToken)
        {
...
#region Drag
    ...
    {
        Ticket<PointerEventData> IAsyncOnDragHandler.OnDragAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDragTrigger : AsyncTriggerBase<PointerEventData>, IDragHandler
    {
        ...
        public Ticket<PointerEventData> OnDragAsync()
        {
            return ((IAsyncOnDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDragAsync();
        }

        public Ticket<PointerEventData> OnDragAsync(CancellationToken cancellationToken)
        {
...
#region Drop
    ...
    {
        Ticket<PointerEventData> IAsyncOnDropHandler.OnDropAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDropTrigger : AsyncTriggerBase<PointerEventData>, IDropHandler
    {
        ...
        public Ticket<PointerEventData> OnDropAsync()
        {
            return ((IAsyncOnDropHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDropAsync();
        }

        public Ticket<PointerEventData> OnDropAsync(CancellationToken cancellationToken)
        {
...
#region EndDrag
    ...
    {
        Ticket<PointerEventData> IAsyncOnEndDragHandler.OnEndDragAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncEndDragTrigger : AsyncTriggerBase<PointerEventData>, IEndDragHandler
    {
        ...
        public Ticket<PointerEventData> OnEndDragAsync()
        {
            return ((IAsyncOnEndDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnEndDragAsync();
        }

        public Ticket<PointerEventData> OnEndDragAsync(CancellationToken cancellationToken)
        {
...
#region InitializePotentialDrag
    ...
    {
        Ticket<PointerEventData> IAsyncOnInitializePotentialDragHandler.OnInitializePotentialDragAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncInitializePotentialDragTrigger : AsyncTriggerBase<PointerEventData>, IInitializePotentialDragHandler
    {
        ...
        public Ticket<PointerEventData> OnInitializePotentialDragAsync()
        {
        ...
        public Ticket<PointerEventData> OnInitializePotentialDragAsync(CancellationToken cancellationToken)
        {
...
#region Move
    ...
    {
        Ticket<AxisEventData> IAsyncOnMoveHandler.OnMoveAsync()
        {
            core.Reset();
            return new Ticket<AxisEventData>((ITicketSource<AxisEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncMoveTrigger : AsyncTriggerBase<AxisEventData>, IMoveHandler
    {
        ...
        public Ticket<AxisEventData> OnMoveAsync()
        {
            return ((IAsyncOnMoveHandler)new AsyncTriggerHandler<AxisEventData>(this, true)).OnMoveAsync();
        }

        public Ticket<AxisEventData> OnMoveAsync(CancellationToken cancellationToken)
        {
...
#region PointerClick
    ...
    {
        Ticket<PointerEventData> IAsyncOnPointerClickHandler.OnPointerClickAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerClickTrigger : AsyncTriggerBase<PointerEventData>, IPointerClickHandler
    {
        ...
        public Ticket<PointerEventData> OnPointerClickAsync()
        {
            return ((IAsyncOnPointerClickHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerClickAsync();
        }

        public Ticket<PointerEventData> OnPointerClickAsync(CancellationToken cancellationToken)
        {
...
#region PointerDown
    ...
    {
        Ticket<PointerEventData> IAsyncOnPointerDownHandler.OnPointerDownAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerDownTrigger : AsyncTriggerBase<PointerEventData>, IPointerDownHandler
    {
        ...
        public Ticket<PointerEventData> OnPointerDownAsync()
        {
            return ((IAsyncOnPointerDownHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerDownAsync();
        }

        public Ticket<PointerEventData> OnPointerDownAsync(CancellationToken cancellationToken)
        {
...
#region PointerEnter
    ...
    {
        Ticket<PointerEventData> IAsyncOnPointerEnterHandler.OnPointerEnterAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerEnterTrigger : AsyncTriggerBase<PointerEventData>, IPointerEnterHandler
    {
        ...
        public Ticket<PointerEventData> OnPointerEnterAsync()
        {
            return ((IAsyncOnPointerEnterHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerEnterAsync();
        }

        public Ticket<PointerEventData> OnPointerEnterAsync(CancellationToken cancellationToken)
        {
...
#region PointerExit
    ...
    {
        Ticket<PointerEventData> IAsyncOnPointerExitHandler.OnPointerExitAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerExitTrigger : AsyncTriggerBase<PointerEventData>, IPointerExitHandler
    {
        ...
        public Ticket<PointerEventData> OnPointerExitAsync()
        {
            return ((IAsyncOnPointerExitHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerExitAsync();
        }

        public Ticket<PointerEventData> OnPointerExitAsync(CancellationToken cancellationToken)
        {
...
#region PointerUp
    ...
    {
        Ticket<PointerEventData> IAsyncOnPointerUpHandler.OnPointerUpAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerUpTrigger : AsyncTriggerBase<PointerEventData>, IPointerUpHandler
    {
        ...
        public Ticket<PointerEventData> OnPointerUpAsync()
        {
            return ((IAsyncOnPointerUpHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerUpAsync();
        }

        public Ticket<PointerEventData> OnPointerUpAsync(CancellationToken cancellationToken)
        {
...
#region Scroll
    ...
    {
        Ticket<PointerEventData> IAsyncOnScrollHandler.OnScrollAsync()
        {
            core.Reset();
            return new Ticket<PointerEventData>((ITicketSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncScrollTrigger : AsyncTriggerBase<PointerEventData>, IScrollHandler
    {
        ...
        public Ticket<PointerEventData> OnScrollAsync()
        {
            return ((IAsyncOnScrollHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnScrollAsync();
        }

        public Ticket<PointerEventData> OnScrollAsync(CancellationToken cancellationToken)
        {
...
#region Select
    ...
    {
        Ticket<BaseEventData> IAsyncOnSelectHandler.OnSelectAsync()
        {
            core.Reset();
            return new Ticket<BaseEventData>((ITicketSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSelectTrigger : AsyncTriggerBase<BaseEventData>, ISelectHandler
    {
        ...
        public Ticket<BaseEventData> OnSelectAsync()
        {
            return ((IAsyncOnSelectHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnSelectAsync();
        }

        public Ticket<BaseEventData> OnSelectAsync(CancellationToken cancellationToken)
        {
...
#region Submit
    ...
    {
        Ticket<BaseEventData> IAsyncOnSubmitHandler.OnSubmitAsync()
        {
            core.Reset();
            return new Ticket<BaseEventData>((ITicketSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSubmitTrigger : AsyncTriggerBase<BaseEventData>, ISubmitHandler
    {
        ...
        public Ticket<BaseEventData> OnSubmitAsync()
        {
            return ((IAsyncOnSubmitHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnSubmitAsync();
        }

        public Ticket<BaseEventData> OnSubmitAsync(CancellationToken cancellationToken)
        {
...
#region UpdateSelected
    ...
    {
        Ticket<BaseEventData> IAsyncOnUpdateSelectedHandler.OnUpdateSelectedAsync()
        {
            core.Reset();
            return new Ticket<BaseEventData>((ITicketSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncUpdateSelectedTrigger : AsyncTriggerBase<BaseEventData>, IUpdateSelectedHandler
    {
        ...
        public Ticket<BaseEventData> OnUpdateSelectedAsync()
        {
            return ((IAsyncOnUpdateSelectedHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnUpdateSelectedAsync();
        }

        public Ticket<BaseEventData> OnUpdateSelectedAsync(CancellationToken cancellationToken)
        {
