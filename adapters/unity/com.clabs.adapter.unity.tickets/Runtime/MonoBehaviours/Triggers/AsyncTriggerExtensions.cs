...
using UnityEngine;
using CLabs.Tickets.Triggers;

namespace CLabs.Tickets
{
    public static class TicketCancellationExtensions
    {
...
namespace CLabs.Tickets.Triggers
{
    public static partial class AsyncTriggerExtensions
    {
        ...
        public static Ticket OnDestroyAsync(this GameObject gameObject)
        {
            return gameObject.GetAsyncDestroyTrigger().OnDestroyAsync();
        }

        /// <summary>This function is called when the MonoBehaviour will be destroyed.</summary>
        public static Ticket OnDestroyAsync(this Component component)
        {
            return component.GetAsyncDestroyTrigger().OnDestroyAsync();
        }

        public static Ticket StartAsync(this GameObject gameObject)
        {
            return gameObject.GetAsyncStartTrigger().StartAsync();
        }

        public static Ticket StartAsync(this Component component)
        {
            return component.GetAsyncStartTrigger().StartAsync();
        }

        public static Ticket AwakeAsync(this GameObject gameObject)
        {
            return gameObject.GetAsyncAwakeTrigger().AwakeAsync();
        }

        public static Ticket AwakeAsync(this Component component)
        {
