...
namespace CLabs.Fork.Unity.Editor {
    public sealed class ForkViewerWindow : CLabsEditorWindow {
        ...
        public static void ShowWindow() {
            var window = GetWindow<ForkViewerWindow>();
        ...
        private void Refresh() {
            var service = Application<IForkService>.Get();
        ...
        private static void OpenSaveFolder() {
            string path;
            try { path = Application<IForkConfiguration>.Get().RootPath; }
