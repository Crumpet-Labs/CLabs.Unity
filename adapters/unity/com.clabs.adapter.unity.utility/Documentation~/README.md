...
Unity bindings for [`com.clabs.utility`](../../../../packages/com.clabs.utility) — the foundational adapter. Every other adapter references this one. Supplies colour conversions, `OwnerId` resolution, player-loop injection, property wrappers, editor drawers, and a set of Unity-flavoured helpers.
...
- `Property<T>` (+ `BoolProperty`, `Vector2Property`) — observable value wrapper with dirty-flag.
...
- [com.clabs.utility/Documentation~/README.md](../../../../packages/com.clabs.utility/Documentation~/README.md)
