    ...
    public static class CrumbPackage {
        public static IConfigurableCollection UseCrumbPackage(this ApplicationBuilder builder) {
            return new ConfigurableCollection()
                .Register(builder.Resolvers.AddSingleton<ICrumbConfiguration>()
                    .WithFactory(() => new CrumbConfiguration()))
                .Register(builder.Resolvers.AddSingleton<ICrumbSink>()
                    .WithFactory(() => new ConsoleCrumbSink()))
