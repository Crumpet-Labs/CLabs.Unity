...
namespace CLabs.Tickets.Linq
{
    ...
    {
        public static IObservable<TSource> ToObservable<TSource>(this ITicketAsyncEnumerable<TSource> source)
        {
    ...
    {
        readonly ITicketAsyncEnumerable<T> source;

        public ToObservable(ITicketAsyncEnumerable<T> source)
        {
            this.source = source;
        }
        ...
        static async TicketVoid RunAsync(ITicketAsyncEnumerable<T> src, IObserver<T> observer, CancellationToken cancellationToken)
        {
