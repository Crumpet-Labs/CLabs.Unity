...
namespace CLabs.Tickets.Linq
{
    ...
    internal abstract class AsyncEnumeratorBase<TSource, TResult> : MoveNextSource, ITicketAsyncEnumerator<TResult>
    {
        ...
        Ticket<bool>.Awaiter sourceMoveNext;

        public AsyncEnumeratorBase(ITicketAsyncEnumerable<TSource> source, CancellationToken cancellationToken)
        {
            this.source = source;
        ...
        public virtual Ticket DisposeAsync()
        {
    ...
    internal abstract class AsyncEnumeratorAwaitSelectorBase<TSource, TResult, TAwait> : MoveNextSource, ITicketAsyncEnumerator<TResult>
    {
        static readonly Action<object> moveNextCallbackDelegate = MoveNextCallBack;
        ...
        Ticket<TAwait>.Awaiter resultAwaiter;

        public AsyncEnumeratorAwaitSelectorBase(ITicketAsyncEnumerable<TSource> source, CancellationToken cancellationToken)
        {
            this.source = source;
            this.cancellationToken = cancellationToken;
            TaskTracker.TrackActiveTask(this, 4);
        ...
        protected abstract Ticket<TAwait> TransformAsync(TSource sourceCurrent);
        ...
        protected bool UnwarapTask(Ticket<TAwait> taskResult, out TAwait result)
        {
