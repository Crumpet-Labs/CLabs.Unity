...
namespace CLabs.Tickets
{
    public partial struct Ticket
    {
        ...
        /// <summary>
        /// If running on mainthread, do nothing. Otherwise, same as Ticket.Yield(PlayerLoopTiming.Update).
        /// </summary>
        ...
        /// <summary>
        /// If running on mainthread, do nothing. Otherwise, same as Ticket.Yield(timing).
        /// </summary>
        ...
        {
            TicketRuntime.AddContinuation(timing, action);
        }
        ...
        public struct Awaiter : ICriticalNotifyCompletion
        {
            ...
            public bool IsCompleted
            {
                get
                {
                    ...
                    if (TicketRuntime.MainThreadId == currentThreadId)
                    {
            ...
            {
                TicketRuntime.AddContinuation(playerLoopTiming, continuation);
            }
    ...
    public struct ReturnToMainThread
    {
        ...
        public readonly struct Awaiter : ICriticalNotifyCompletion
        {
            ...
            public bool IsCompleted => TicketRuntime.MainThreadId == System.Threading.Thread.CurrentThread.ManagedThreadId;
